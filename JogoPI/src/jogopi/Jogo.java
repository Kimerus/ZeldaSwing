...
//                this.PauseMenu();
                ...
                System.out.println(pauseSelect);
                this.repaint();
                try {
                    Thread.sleep(10);
    ...
    private void DebugGrid(Graphics g) {
        int t = 0;
        BufferedImage line = SpriteUpdate(imgPath + "line V.png");
        while (t < this.getWidth()) {
            g.drawImage(line, t - 2, 0, this);
            t += 50;
        }

        t = 0;
        line = SpriteUpdate(imgPath + "line H.png");
        while (t < this.getHeight()) {
            g.drawImage(line, 0, t - 2, this);
            t += 50;
        }
    }
    ...
    private void DrawPauseMenu(Graphics g) {
        ...
        mapa = SpriteUpdate(imgPath + "mapa.png");
